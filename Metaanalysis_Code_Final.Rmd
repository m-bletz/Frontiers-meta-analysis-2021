...
forest(Genotype_basemod, atransf=exp, at=log(c(.05, .25, 1, 4,10,40)), xlim=c(-12,10), cex=.75, header="Study ID", mlab="")
...
*I will reorder in illustrator to larvae-meta-adult*
...
forest(Genotype_basemod_noOL_LS, xlim=c(-12, 10), at=log(c(0.05, 0.25, 1, 4,10)), atransf=exp,
      cex=0.6, ylim=c(-1, 28),
      rows=c(3:9,12:17,20:22),
       mlab=mlabfun("RE Model for All Studies", Genotype_basemod_noOL_LS),
       psize=1, header="Study ID")
op <- par(cex=0.75, font=2)
### add text for the subgroups
text(-12, c(23,18,10), pos=4, c("Metamorph",
                               "Larvae*",
                               "Adult"))
...
addpoly(Genotype_basemod_noOL_LSm, row= 19, cex=0.6, atransf=exp, mlab=mlabfun("REM", Genotype_basemod_noOL_LSm))
...
predict(Genotype_basemod_noOL_LS, newmods=c(1,0), transf=exp, digits=2)
```
...
forest(Location_basemod_GPLs, atransf=exp, at=log(c(.05, .25, 1, 4)), xlim=c(-16,6), cex=.75, header="Study ID", mlab="")
...
# Hat value outliers > 3*(1/k) == 3*(1/19) == 0.158 
